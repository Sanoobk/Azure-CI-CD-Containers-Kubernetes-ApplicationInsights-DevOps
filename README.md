...
![Components and Configuraiton list](/Images/Components.PNG)
...
![Image for the Docker Support Setting](/Images/DockerIntegration.PNG)
...
![Image for Task to depoy to AKS](/Images/DeploytoAKS.PNG)
